...
- **Для личного, образовательного и внутреннего использования**  
  (CI/CD, DevOps, мониторинг, автоматизация внутри компании без продажи доступа к самому UI третьим лицам) — **бесплатно** под лицензией [MIT](LICENSE.mit).
...
> 💡 **Важно:** Использование Containerd UI для деплоя и управления вашими собственными коммерческими проектами (интернет-магазины, CRM, стартапы) **всегда бесплатно**. Платить нужно только если вы продаёте сам инструмент или его функциональность как отдельный продукт.
