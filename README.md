...
- **Для личного, образовательного и внутреннего использования** (CI/CD, DevOps, мониторинг внутри компании без продажи доступа клиентам) — **бесплатно** под лицензией [MIT](LICENSE.mit).
- **Для коммерческого использования** (SaaS, продажа доступа, включение в коммерческий продукт) — требуется **платная коммерческая лицензия**.

📧 Для получения коммерческой лицензии: soulbialogur@gmail.com
