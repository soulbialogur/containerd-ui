...
> Важно: требования к сети `soul-dialogue`, правильному `compose.yaml` и корню проекта описаны в [project-requirements.md](project-requirements.md). Это единственная точка, где зафиксированы обязательные условия для корректного деплоя.
